...
export async function sendLoginCodeEmail(
  ...
  // Stampa il codice nel terminale per testare l'accesso senza Resend configurato
  ...
  // In dev (senza chiave) il codice è già stato stampato nel terminale
  return result.sent || Boolean(result.dev)
}
